...
export function MobileBadge() {
  ...
  return (
    <button 
      ...
      onTouchEnd={(e) => { e.preventDefault(); scrollToSection(); }}
      className="group relative z-20 cursor-pointer"
      style={{ WebkitTapHighlightColor: 'transparent', touchAction: 'manipulation' }}
    >
      <div className="flex items-center gap-3 px-5 py-2.5 bg-black border border-white/20 rounded-xl hover:bg-white/5 active:bg-white/10 transition-colors">
