        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-4 gap-4">
              {ADDONS.map((addon) => (
                <div key={addon.name} onClick={() => handleAddonPurchase(addon.id)} className="group relative p-4 rounded-xl cursor-pointer transition-all hover:border-[#D4A017]/50 hover:bg-[#D4A017]/5 bg-white/5 border border-white/10">
                  ...
                  {/* Tooltip on hover */}
                  <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-2 bg-black/95 border border-[#D4A017]/30 rounded-lg text-xs text-white/80 w-48 text-center opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50 shadow-xl">
                    {addon.tooltip}
