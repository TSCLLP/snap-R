      ...
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-white/10 bg-[#0F0F0F]/90 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            <div className="w-10 h-10 rounded-xl flex items-center justify-center text-white font-bold bg-gradient-to-br from-emerald-400 to-emerald-600 shadow-lg shadow-emerald-500/30">S</div>
            <span className="text-2xl font-bold text-white">Snap<span className="text-emerald-400">R</span></span>
          </Link>
          <div className="hidden md:flex items-center gap-8">
            <Link href="#features" className="text-white/70 hover:text-emerald-400 transition-colors">Features</Link>
            <Link href="#pricing" className="text-white/70 hover:text-emerald-400 transition-colors">Pricing</Link>
            <Link href="/faq" className="text-white/70 hover:text-emerald-400 transition-colors">FAQ</Link>
          </div>
          <div className="flex items-center gap-4">
            <Link href="/auth/login" className="text-white/70 hover:text-white transition-colors">Log in</Link>
            <Link href="/auth/signup" className="btn-gold-glass">Start Free Trial</Link>
          </div>
        </div>
      </nav>

      <section className="pt-36 pb-16 px-6 relative overflow-hidden">
        <div className="absolute top-20 left-1/4 w-[500px] h-[500px] bg-emerald-500/10 rounded-full blur-[100px]"></div>
        <div className="absolute bottom-0 right-1/4 w-[400px] h-[400px] bg-[#D4A017]/10 rounded-full blur-[80px]"></div>
        
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full mb-8 text-sm bg-emerald-500/10 border border-emerald-500/30">
            <Sparkles className="w-4 h-4 text-emerald-400" />
            <span className="text-emerald-400">AI-Powered Real Estate Photo Enhancement</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/auth/signup" className="btn-gold-glass text-lg px-8 py-4">
          ...
          <div className="flex items-center justify-center gap-8 mt-8 text-white/40 text-sm">
            <span className="flex items-center gap-2"><Check className="w-4 h-4 text-emerald-400" /> 5 Free Credits</span>
            <span className="flex items-center gap-2"><Check className="w-4 h-4 text-emerald-400" /> No Credit Card</span>
            <span className="flex items-center gap-2"><Check className="w-4 h-4 text-emerald-400" /> 30-Second Results</span>
          </div>
        </div>
      </section>
      ...
      <section id="mobile-section" className="py-24 px-6 bg-gradient-to-b from-[#0F0F0F] to-[#0A0A0A]">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-4 bg-emerald-500/10 border border-emerald-500/30">
              <Smartphone className="w-4 h-4 text-emerald-400" />
              <span className="text-emerald-400 text-sm font-medium">Industry First</span>
            </div>
            ...
            {[
              ...
              <div key={i} className="relative">
                <div className="glass-card p-6 h-full">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center text-white font-bold text-lg mb-4">
                    {item.step}
                  </div>
          ...
          <div className="text-center mt-12">
            <Link href="/auth/signup" className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-xl font-semibold text-white hover:opacity-90 transition-opacity">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="glass-card p-6 hover:border-emerald-500/30 transition-all">
      ...
      <section id="pricing" className="py-24 px-6 bg-[#0A0A0A]">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="glass-card-gold p-8 mb-12 max-w-2xl mx-auto text-center">
            ...
            <Link href="/auth/signup" className="btn-gold-glass">Get Started Free</Link>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="glass-card p-8">
              ...
              <ul className="space-y-3 mb-8">
                {['50 Credits/month', 'All AI Tools', 'Email Support'].map((item, i) => (
                  <li key={i} className="flex items-center gap-3 text-white/70"><Check className="w-4 h-4 text-emerald-400" /> {item}</li>
                ))}
              </ul>
              <Link href="/auth/signup" className="btn-dark-glass w-full justify-center">Get Started</Link>
            </div>
            ...
            <div className="glass-card-gold p-8 relative border-2 border-[#D4A017]/50">
              ...
              <Link href="/auth/signup" className="btn-gold-glass w-full justify-center">Subscribe Now</Link>
            </div>
            ...
            <div className="glass-card p-8">
              ...
              <Link href="/auth/signup" className="btn-dark-glass w-full justify-center">Contact Sales</Link>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-lg font-bold text-white">Snap<span className="text-emerald-400">R</span></span>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-white/40 text-sm">
                <li><a href="mailto:support@snapr.ai" className="hover:text-emerald-400">support@snapr.ai</a></li>
              </ul>
            </div>
          </div>
