...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#0F0F0F] font-['Outfit']">
      ...
      {/* Simple Pricing CTA */}
      <section className="py-20 px-6 bg-gradient-to-b from-[#0F0F0F] to-[#0A0A0A]">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Simple, Transparent Pricing</h2>
          <p className="text-lg text-white/60 mb-8">
            Starting at <span className="text-[#D4A017] font-bold">$12/listing</span> for photographers.<br />
            Full marketing suite from <span className="text-[#D4A017] font-bold">$18/listing</span> for agents.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/pricing" className="px-8 py-4 bg-gradient-to-r from-[#D4A017] to-[#B8860B] text-black font-bold rounded-xl text-lg inline-flex items-center gap-2 hover:opacity-90 transition">
              View Pricing <ArrowRight className="w-5 h-5" />
            </Link>
            <Link href="/auth/signup" className="px-8 py-4 bg-white/10 hover:bg-white/20 text-white font-medium rounded-xl text-lg border border-white/20 transition">
              Start Free
            </Link>
          </div>
          <p className="text-sm text-white/40 mt-6">3 free listings/month • No credit card required</p>
        </div>
      </section>
