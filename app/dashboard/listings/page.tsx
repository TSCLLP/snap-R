...
import { Plus, Home, Image, MapPin, CheckCircle, AlertCircle, Clock } from 'lucide-react'
...
export default async function ListingsPage() {
  ...
  const { data: listings } = await supabase.from('listings').select('*, photos(id, raw_url, processed_url, status), status, prepared_at, hero_photo_id').eq('user_id', user.id).order('created_at', { ascending: false })
