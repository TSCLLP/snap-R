    ...
    <div className="min-h-screen bg-[#0F0F0F] flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-emerald-500 to-emerald-700 p-12 flex-col justify-between">
        ...
        <div>
          ...
          <p className="text-white/80 text-lg">Get 5 free credits to experience AI-powered photo enhancement.</p>
        </div>
        <p className="text-white/50 text-sm">© 2025 SnapR Inc.</p>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <button onClick={handleGoogleSignup} className="w-full py-3 px-4 rounded-xl border border-white/20 text-white hover:bg-white/5 flex items-center justify-center gap-3 mb-6">
